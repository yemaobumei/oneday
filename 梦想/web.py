...
URL='http://h5.weiyingonline.com/share_play/SharePlayAction.a?clickShare=&shareDetailId=1073212&from=timeline&isappinstalled=1:548'
...
URL2='http://hls.weiyingonline.com/live/ea94286fba51126d22db78076c398440/playlist.m3u8'
headers2={
'Host': 'hls.weiyingonline.com',
'Connection': 'keep-alive',
'Accept-Encoding': 'identity;q=1, *;q=0',
'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36',
'Accept': '*/*',
'Referer': 'http://h5.weiyingonline.com/share_play/SharePlayAction.a?clickShare=&shareDetailId=1073212&from=timeline&isappinstalled=1',
'Accept-Language': 'zh-CN,zh;q=0.8',
'Range': 'bytes=0-236'
}
cookies=dict(totoro_share_click_cookie='1484104415387_2658',totoro_cookie='1484104415394_3049',JSESSIONID='5166DB805D853BFDD0FAF3AC73C9DDD8')
s=requests.Session()
s.hearders=headers

for i in range(len(DESKTOP_USER_AGENTS)):
	headers['User-Agent']=DESKTOP_USER_AGENTS[i]
	headers2['User-Agent']=DESKTOP_USER_AGENTS[i]
#	s=requests.get(URL,headers=headers,cookies=cookies)	
#	s=requests.get(URL2,headers=headers2)
	s.hearders=headers
